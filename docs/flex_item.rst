...
The size of a FlexItem is determined by two things
 ...
 - The size of its content (if it has any), determined by the ``wrap_content(content_width, content_height)`` method used to determine the size of the content in the FlexItem. By default wrap_content returns 0, 0
