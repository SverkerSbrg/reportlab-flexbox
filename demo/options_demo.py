...
justify_content = FlexBox2(
    *list(FlexBox2(
            FlexParagraph2(str(justify_content), h2, width="100%", padding=[spacing, spacing/2, 0]),
            DemoFlexBox(
...
align_items = FlexBox2(
    *list(FlexBox2(
        FlexParagraph2(str(align_items), h2, width="100%", padding=[spacing, spacing / 2, 0]),
        DemoFlexBox(
...
align_content = FlexBox2(
    *list(FlexBox2(
        FlexParagraph2(str(align_content), h2, width="100%", padding=[spacing, spacing / 2, 0]),
        DemoFlexBox(
...
if __name__ == "__main__":
    ...
    doc.build(
        flowables=[
            FlexParagraph2("JustifyContent", h1, width="100%", padding=(spacing*2, 0, 0)),
            justify_content,
            FlexParagraph2("AlignItems", h1, width="100%", padding=(spacing*2, 0, 0)),
            align_items,
            FlexParagraph2("AlignContent", h1, width="100%", padding=(spacing*2, 0, 0)),
            align_content,
        ]
    )